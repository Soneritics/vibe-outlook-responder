...
describe('ModelSelector', () => {
  ...
  describe('rendering', () => {
    ...
    it('should display available models', () => {
      ...
      // Check that at least GPT-4o option exists
    ...
    it('should default to GPT-4o when no value provided', () => {
  ...
  describe('model information', () => {
    it('should show description for selected model', () => {
      ...
      expect(screen.getByText(/Latest and most capable/i)).toBeInTheDocument();
    });

    it('should show token limit information', () => {
      render(<ModelSelector value="gpt-4o" onChange={mockOnChange} />);

      expect(screen.getByText(/128K tokens/i)).toBeInTheDocument();
    });
  });
  ...
  describe('interactions', () => {
    ...
    it('should update displayed value when selection changes', () => {
      const { rerender } = render(<ModelSelector value="gpt-4o" onChange={mockOnChange} />);
  ...
  describe('model options', () => {
    ...
    it('should display user-friendly model names', () => {
      ...
      // Check that the dropdown contains text with "GPT-4o"
